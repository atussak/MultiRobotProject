...
let PrintGoal = require('./PrintGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PrintActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PrintGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PrintActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PrintGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PrintGoal()
    }
...
module.exports = PrintActionGoal;
